...
export function Hero({ onNavigate, pains }) {
  useEffect(() => {
  ...
  const solvedPains = pains ? pains.filter(p => p.status === 'solved' && p.toolName) : [];
  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="hero__ascii animate-fade-in delay-300">
        <pre className="hero__ascii-pre">
{`@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
          ...
          <div className="hero__trending-body">
            <div className="hero__trending-left">
              <div className="hero__trending-meta">
                <span className="hero__trending-title">{trendingTool.toolName}</span>
              ...
              <p className="hero__trending-desc">{trendingTool.toolDescription || 'A helpful solution built for user pains.'}</p>
            </div>
            <a 
              href={trendingTool.toolUrl} 
              target="_blank" 
